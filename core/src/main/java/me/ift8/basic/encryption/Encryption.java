package me.ift8.basic.encryption;
...
public class Encryption {
    ...
    public Encryption() {
        this("kzjr", "1YpgSBK{b1QVMycl");
    }

    public Encryption(String key, String salt) {
        this(key, salt, 16);
    }

    public Encryption(String key, String salt, int bit) {
        byte[] iv = new byte[bit];
        this.mBuilder = Builder.getDefaultBuilder(key, salt, iv);
        try {
            this.mBuilder.build();
    ...
    public String decryptOrNull(String data) {
        try {
            ...
            log.error("decryptOrNull error ", e);
            return null;
        }
    }
