...
import com.kongzhong.finance.basic.trace.config.AppConfiguration;
 ...
 * !!! Changed
 * class 去除 final
 * 扩展 {@link ch.qos.logback.classic.Logger#buildLoggingEventAndAppend(java.lang.String, org.slf4j.Marker, ch.qos.logback.classic.Level, java.lang.String, java.lang.Object[], java.lang.Throwable)}
 *
 */
public class Logger implements org.slf4j.Logger, LocationAwareLogger, AppenderAttachable<ILoggingEvent>, Serializable {
    ...
    protected Logger(String name, Logger parent, LoggerContext loggerContext) {
        this.name = name;
        this.parent = parent;
    ...
    private void buildLoggingEventAndAppend(final String localFQCN, final Marker marker, final Level level, final String msg, final Object[] params,
                                            final Throwable t) {
        LogEvent le = new LogEvent(localFQCN, this, level, msg, t, params);
        le.setMarker(marker);
     ...
     * 扩展信息
     */
    private void stuffLogEvent(LogEvent le){
     ...
     * 会话跟踪信息
     */
    private void setTraceInfo(LogEvent le) {
        le.setAppId(AppConfiguration.getAppId());
        // TODO: 2017/3/31
//        le.setRequestId();
    }
